...
void main() {
  test('parses the observed hospital roster layout', () {
    const input = ShiftParserInput(
      ...
      cells: [
        NormalizedCell(sheetId: 1, sheetTitle: 'Sheet', a1: 'A1', rowIndex: 0, columnIndex: 0, text: 'เวร'),
        NormalizedCell(sheetId: 1, sheetTitle: 'Sheet', a1: 'A2', rowIndex: 1, columnIndex: 0, text: 'วันที่'),
        NormalizedCell(sheetId: 1, sheetTitle: 'Sheet', a1: 'B2', rowIndex: 1, columnIndex: 1, rawValue: 16),
        NormalizedCell(sheetId: 1, sheetTitle: 'Sheet', a1: 'C3', rowIndex: 2, columnIndex: 2, text: 'ประจำเดือน 16 กรกฎาคม พ.ศ. 2569 - 15 สิงหาคม พ.ศ. 2569'),
        NormalizedCell(sheetId: 1, sheetTitle: 'Sheet', a1: 'A10', rowIndex: 9, columnIndex: 0, text: 'P2 บ่าย'),
        NormalizedCell(sheetId: 1, sheetTitle: 'Sheet', a1: 'B10', rowIndex: 9, columnIndex: 1, text: 'ภาคภูมิ'),
      ],
    );
