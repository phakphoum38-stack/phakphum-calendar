...
- สร้างกิจกรรม `OFF` เวลา 08:00–16:00 อัตโนมัติหลังเวรดึก 00:00–08:00
- ตรวจเวรซ้อนจากชีต เวรที่ชนช่วงออฟ และเวรที่ชนกิจกรรมเดิมใน Google Calendar
- แท็บแจ้งเตือนพร้อมปุ่ม `ยอมรับ`, `รับเวร` และ `ยกเลิก`; รายการค้างจะบล็อกการซิงก์ Calendar
- แท็บ `Adsite ตารางเวร` เป็นหน้าว่างสำหรับเชื่อมข้อมูลในภายหลัง
...
กติกาเวรออฟปัจจุบันใช้ช่วง 08:00–16:00 ในวันที่เวรดึกสิ้นสุด การกด `ยอมรับ` จะรับทราบและคงรายการตามชีต, `รับเวร` จะยืนยันรับแม้มีการชน (และยกเลิกช่วง OFF เมื่อเกี่ยวข้อง), ส่วน `ยกเลิก` จะไม่นำเวรที่ชนไปบันทึก การตรวจชนกับกิจกรรมภายนอกจะแสดงหลังผู้ใช้กด **เปรียบเทียบ Calendar**
