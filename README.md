...
1. กด **ค้นหาจากประวัติอัปเดต Sheets** เพื่อดูไฟล์ที่บัญชีนี้แก้ไขล่าสุด หรือวาง URL ในช่อง **ลิงก์ Google Sheets ต้นฉบับ**
2. กรอก **ชื่อที่ต้องค้นหา** ให้ตรงกับชื่อในตารางเวร หรือปล่อยว่างเพื่อใช้ชื่อบัญชี Google
3. เลือก **เดือน** และ **ปี ค.ศ.** ซึ่งเริ่มต้นว่าง
...
6. ไปแท็บ **ตัวอย่าง** เพื่อตรวจวัน เวลา ประเภทเวร สี และเลือกว่าจะนำรายการใดไปใช้
...
#### ค้นหาไฟล์ต้นฉบับจากประวัติอัปเดต

- แอปเรียก Drive `files.list` ด้วย `drive.metadata.readonly` และแสดงเฉพาะ Google Sheets ที่บัญชีปัจจุบันเป็นเจ้าของ
- รายการเรียงตาม `modifiedByMeTime` ล่าสุด สูงสุด 20 ไฟล์ และแสดง 10 ไฟล์แรกในหน้าแรก
